...
### Realización
* Para conseguir esto, tendremos que quitarle el privilegio a ROLPRACTICA1, que es la razón real porque la que . Si intentamos quitarle el privilegio a USRPRACTICA1, no funcionará, porque oracle no permite quitar privilegios que no se han dado.
```
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTgxOTYyMjIyNSwxNjUzMjE4Mjc5LDM3Nz
